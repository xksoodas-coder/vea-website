...
export default async function RootLayout({
  ...
  return (
    <html
      lang={lang}
      dir={dirOf(lang)}
      /* Required by the App Router: without it the `scroll-behavior: smooth`
         set in globals.css swallows the router's scroll-to-top, and every
         navigation lands on the new page at the previous scroll position. */
