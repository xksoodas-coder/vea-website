...
export default async function Home({ params }: PageProps<"/[lang]">) {
  ...
  return (
    <>
      <a
        href="#products"
        className="sr-only focus:not-sr-only focus:fixed focus:top-3 focus:start-3 focus:z-100 focus:rounded-lg focus:bg-plum focus:px-6 focus:py-3 focus:text-sm focus:text-ivory"
      >
